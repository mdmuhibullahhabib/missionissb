...
const McqCard = () => {
    ...
    const fakeUser = {
        name: "John Doe",
        subscription: "active", // change to "active" to unlock question view
    };
    ...
    return (
        <>
            <div className="mt-4 bg-white border p-6 rounded-xl shadow-sm relative">
                ...
                -------------------------------- */}
                <h3
                    className={`font-semibold text-lg cursor-pointer ${fakeUser.subscription === "pending"
                ...
                <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-3">
                    {question.options.map((opt, i) => (
                        <div
                            key={i}
                            onClick={() => {
                                // If subscription pending → show modal
                                if (fakeUser.subscription === "pending") {
                                    setShowModal(true);
                                    return;
                                }
