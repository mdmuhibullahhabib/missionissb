...
const SubmitModal = ({ isOpen, onClose, onSubmit }) => {
  ...
  return (
    <div
    //   className="fixed inset-0 z-50 flex items-start pt-16 justify-center bg-blur bg-opacity-50"
     className="fixed inset-0 z-50 flex items-start pt-16 justify-center bg-black bg-opacity-50 backdrop-blur-sm"
